       ...
       <div>
        ...
        <div className='grid md:grid-cols-5 grid-cols-2 gap-7  my-3'>
            {cardItem.map(({id, logo, name}) => (
                <div className='flex flex-col items-center justify-center border rounded-full p-2  shadow-lg
                cursor-pointer hover:scale-90 md:hover:scale-110 duration-200  ' key={id}>
                    <img className='w-[150px] rounded-full p-2 ' src={logo} alt='react_logo' />
                    <div>
